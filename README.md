...
- **[Agent providers](https://utensils.github.io/claudette/features/providers/)** — choose Claude Code, Ollama (local), the OpenAI API, or Codex as first-class agent backends. Gateway and app-server paths adapt chat controls to whichever provider is active.
